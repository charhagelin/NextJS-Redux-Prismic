  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(PostsList, [{
    ...
    value: function renderPosts() {
      ...
      this.props.data.length >= 1 ? this.props.data.map(function (posts) {
        if (posts.type === "post") console.log("here", posts);

        _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(_this.props.data).map(function (key) {
          var posts = data[key];
...
//# sourceMappingURL=posts.js.f268f44bd5bb50f62844.hot-update.js.map