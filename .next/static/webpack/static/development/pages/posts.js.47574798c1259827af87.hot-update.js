  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(PostsList, [{
    ...
    value: function renderPosts() {
      ...
      this.props.data.length >= 1 ? this.props.data.map(function (posts) {
        if (posts.type === "post") console.log("here", posts.data);

        _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(posts.data).map(function (key) {
          var posts = posts.data[key];
          var data = posts.data[key].data;
...
//# sourceMappingURL=posts.js.47574798c1259827af87.hot-update.js.map