    ...
    value: function renderPosts() {
      ...
      this.props.data.length >= 1 ? this.props.data.map(function (posts) {
        if (posts.type === "post") {
          ...
          posts.data && _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(posts.data).map(function (key) {
...
//# sourceMappingURL=posts.js.580479b10c7335bd88a2.hot-update.js.map