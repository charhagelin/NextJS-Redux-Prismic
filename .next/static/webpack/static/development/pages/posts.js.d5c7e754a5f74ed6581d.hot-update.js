...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(PostsList, [{
    ...
    value: function renderPosts() {
      ...
      this.props.data.length >= 1 ? _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(this.props.data).map(function (key) {
        var posts = _this.props.data[key];
        var data = _this.props.data[key].data;
        console.log("data", posts);
        if (posts.type === "post") return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("ul", {
          key: posts.id,
          __source: {
...
//# sourceMappingURL=posts.js.d5c7e754a5f74ed6581d.hot-update.js.map